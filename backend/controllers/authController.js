...
// Import SessionStorage and use its 'Memory' property as per the official Shopify API documentation.
import { shopifyApi, LATEST_API_VERSION, SessionStorage } from '@shopify/shopify-api';
